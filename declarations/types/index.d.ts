...
export type IOidTreeNode = IOidsItem & {
    children?: IOidTreeNode[];
    address?: string;
};
export declare function isSuccessfulDiscover(result: IDiscoverResult): boolean;
export type NodeToUpdate = {
    name: string;
    id: string;
    idNetwork: string;
    saveTimeSeries: boolean;
